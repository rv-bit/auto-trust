	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"bg-sidebar relative w-(--sidebar-width) transition-[width] delay-0 duration-350 ease-[cubic-bezier(0.76,0,0.24,1)]",
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-350 ease-[cubic-bezier(0.76,0,0.24,1)] md:flex",
					side === "left"
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
	return (
		<main
			...
			className={cn(
				"bg-background relative w-full min-w-0 flex-1 transform overflow-hidden duration-150 ease-linear",
				"md:peer-data-[variant=inset]:m-1.5 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-lg md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:m-0",
				// Add proper margin for the sidebar when it's open
...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
	return (
		<ul
			...
			className={cn("border-sidebar-border ml-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l py-0.5 pl-2.5", "group-data-[collapsible=icon]:hidden", className)}
			{...props}
		/>
	);
}
