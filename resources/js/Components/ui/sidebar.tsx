    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar text-sidebar-foreground max-w-(--sidebar-width) w-full p-0 [&>button]:hidden"
          style={
            {
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-sidebar-accent relative flex max-w-full min-h-svh flex-1 flex-col",
