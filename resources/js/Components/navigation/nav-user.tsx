		...
		<SidebarMenu>
			<SidebarMenuItem>
				<DropdownMenu>
					...
					<DropdownMenuContent className="w-(--radix-dropdown-menu-trigger-width) min-w-56 rounded-lg dark:bg-sidebar-accent" align="end" side={isMobile ? "bottom" : state === "collapsed" ? "left" : "bottom"}>
