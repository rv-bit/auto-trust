...
geocodePostcode.url = (args: { postcode: string | number } | [postcode: string | number] | string | number, options?: RouteQueryOptions) => {
	...
	return geocodePostcode.definition.url.replace("{postcode}", parsedArgs.postcode.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
updateStatus.url = (args: { vehicle: number | { id: number } } | [vehicle: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
	...
	const parsedArgs = {
		vehicle: typeof args.vehicle === "object" ? args.vehicle.id : args.vehicle,
	};

	return updateStatus.definition.url.replace("{vehicle}", parsedArgs.vehicle.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
show.url = (args: { vehicle: number | { id: number } } | [vehicle: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
	...
	return show.definition.url.replace("{vehicle}", parsedArgs.vehicle.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
update.url = (args: { vehicle: number | { id: number } } | [vehicle: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
	...
	return update.definition.url.replace("{vehicle}", parsedArgs.vehicle.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
destroy.url = (args: { vehicle: number | { id: number } } | [vehicle: number | { id: number }] | number | { id: number }, options?: RouteQueryOptions) => {
	...
	return destroy.definition.url.replace("{vehicle}", parsedArgs.vehicle.toString()).replace(/\/+$/, "") + queryParams(options);
};
...
showPage.url = (args: { id: string | number } | [id: string | number] | string | number, options?: RouteQueryOptions) => {
	...
	return showPage.definition.url.replace("{id}", parsedArgs.id.toString()).replace(/\/+$/, "") + queryParams(options);
};
